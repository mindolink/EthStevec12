...
def drawingPowerGraph(axs,UserData,PowerLow,PowerHigh):
    ...
    axs.fill_between(UserData[0],UserData[3],  step="pre", alpha=0.2,facecolor='blue', label="PdSr")
    ...
    axs.plot(UserData[0],UserData[5],drawstyle="steps",color='darkgreen',linewidth=0.7)
    ...
    axs.plot(UserData[0],Pgrd,drawstyle="steps",color='#222222',linewidth=2, label="Pgrd")
...
drawingPriceGraph4Users(FileDirecotory,10,2,[2,2,1,1,1,1,1])